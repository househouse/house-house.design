...
self.addEventListener('install', function (event) {
    ...
    // We open a cache…
    caches.open('simple-sw-v5-17-06-29d').then(function (cache) {

        // And add resources to it
        return cache.addAll(['/', '/assets/js/logging.js', '/assets/js/main.js', '/assets/css/main.css', '/assets/video/house-house--glitch.mp4', '/assets/img/glitch.jpg', '/assets/img/housecss-logo.png', '/assets/img/project--kost.jpg', '/assets/img/project--bitchpop.gif', '/assets/img/project--stanford.jpg', '/assets/img/project--askwill.gif', '/assets/img/project--blancink.jpg', '/assets/img/project--lawnpartyfilms.jpg', '/assets/img/portrait--ben-groulx--animated.gif', '/assets/img/portrait--sean-durfee--animated.gif', '/assets/img/portrait--caitlin-farquharson--animated.gif', '/assets/img/parrot.gif']);
    }));
});
...
self.addEventListener('activate', function (event) {
    var cacheWhiteList = ['simple-sw-v5-17-06-29d'];
