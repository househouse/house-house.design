    ...
    section.c-section
        div.c-contain
            ...
            div.c-text-content.u-color-grey-dark
                p If your team needs to get organized, launch a service, or build a product, then a designer from House House can help you get there. By combining the strategic and the execution, we’ll push you to build towards a mission, towards user needs, towards inclusivity. It’s part of #[router-link(to='/about') how we approach projects].

                p Working with House House means having access to our resident group of design thinkers and doers, who will become an extension of your team. Our residents think in code, in motion, in imagery, in words; we do as coaches do, as students do — and #[router-link(to='/process') we’re ready figure out your next challenge].
