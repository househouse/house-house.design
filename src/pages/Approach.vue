    ...
    section.c-section
        article.c-contain
            ...
            div.c-text-content.u-color-grey-dark
                p We’re organized a bit differently than the last agency you worked with, and we think that’s our biggest strength. With a tiny full-time staff and a big network, we can adapt and scale just as your teams and projects do.
