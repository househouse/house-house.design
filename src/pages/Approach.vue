...
div#pageApproach
    ...
    modal(v-show="isModalFEDVisible" @close="closeModalFED" class="c--right c--purple-light")
        div.u-color-white(slot="header") ⌨️ Front-End Development
        div.c-text-content(slot="body")
